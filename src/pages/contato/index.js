...
export const Contato = () => {
    ...
    const handleCheckedSubjects = (subject) => {
        ...
        if(!contactFormInfo.subjects.includes(subject)) {
            ...
            newSubjects = contactFormInfo.subjects.filter(info => info !== subject);
        }
    ...
    <Box mt="100px" px="10%" textAlign="center" mb="50px">
        ...
        <Typography variant="body1" my="20px" px="10%">
            ...
            Por meio de nossa ampla rede de Parceiros, desenvolvemos projetos personalizados de acordo com as demandas de cada cliente. <br/> <br/>
            Envie-nos uma mensagem e conte-nos um pouco de suas necessidades. Depois, podemos marcar uma conversa por telefone ou videoconferência.
        </Typography>

        <Grid container spacing={2} textAlign="start" paddingX="10%" mt="3%">
            <Grid item md={6}>
                <Box my="25px">
                    <Typography variant="body1" color={colors.blueLighter}>Nome*</Typography>
                    <TextField 
                        required 
                        fullWidth 
                        variant="filled" 
                ...
                <Box my="25px">
                    <Typography variant="body1" color={colors.blueLighter}>E-mail*</Typography>
                    <TextField
                        required 
                        fullWidth 
                        variant="filled" 
                ...
                <Box my="25px">
                    <Typography variant="body1" color={colors.blueLighter}>Empresa</Typography>
                    <TextField 
                        fullWidth 
                        variant="filled" 
                        id="empresa" 
                        onChange={({ target }) => handleInput(target.value, 'empresa')} 
                    />
                </Box>
            </Grid>
            <Grid item md={6}>
                <Typography variant="body1" color={colors.blueLighter}>Selecione um ou mais assuntos*</Typography>
                <FormControl>
                    <Grid container>
                        {contatoSubjects.map(cs => (
                            <Grid item md={5}>
                                <FormControlLabel control={<Checkbox onChange={() => handleCheckedSubjects(cs)} />} label={cs} />
                            </Grid>
                        ))}
                    </Grid>
                </FormControl>
                ...
                <Box my="20px">
                <Typography variant="body1" color={colors.blueLighter}>Mensagem*</Typography>
                    <TextField 
                        required
                        fullWidth 
                        variant="filled" 
                        id="email" 
                        onChange={({ target }) => handleInput(target.value, 'mensagem')} 
                        multiline
                        minRows={4}
                    />
                </Box>
    ...
    <VamosColaborarContainer>
        ...
        <FormControl>
            <RadioGroup value={collabOption} onChange={({ target }) => handleCollabOption(target.value)}>
        ...
        <Box my="25px" mx="10%" textAlign="start">
            <Typography variant="body1" color={colors.blueLighter}>Conte-nos um pouco mais sobre seu projeto (nome e solução que ele oferece).</Typography>
            <TextField 
                fullWidth 
                variant="filled" 
                id="empresa" 
                onChange={({ target }) => handleCollabInput(target.value, 'maisSobre')}
                multiline
                minRows={4}
            />
            ...
            <Grid container spacing={4}>
                <Grid item md={6}>
                    <Box my="25px">
                        <Typography variant="body1" color={colors.blueLighter}>Seu site (se tiver)</Typography>
                        <TextField 
                            required 
                            fullWidth 
                            variant="filled" 
                            id="site" 
                            onChange={({ target }) => handleCollabInput(target.value, 'site')} 
                        />
                    </Box>
                    <Box my="25px">
                        <Typography variant="body1" color={colors.blueLighter}>Linkedin</Typography>
                        <TextField 
                            required 
                            fullWidth 
                            variant="filled" 
                            id="linkedin" 
                            onChange={({ target }) => handleCollabInput(target.value, 'linkedin')} 
                        />
                    </Box>
                </Grid>
                <Grid item md={6}>
                    <Box my="25px">
                        <Typography variant="body1" color={colors.blueLighter}>YouTube</Typography>
                        <TextField 
                            required 
                            fullWidth 
                            variant="filled" 
                            id="youtube" 
                            onChange={({ target }) => handleCollabInput(target.value, 'youtube')} 
                        />
                    </Box>
                    <Box my="25px">
                        <Typography variant="body1" color={colors.blueLighter}>Instagram</Typography>
                        <TextField 
                            required 
                            fullWidth 
                            variant="filled" 
                            id="instagram" 
                            onChange={({ target }) => handleCollabInput(target.value, 'instagrams')} 
                        />
                    </Box>
                </Grid>
            </Grid>
    ...
    <Box my="50px" px="10%" textAlign="center">
        ...
        <Typography variant="body1" my="20px" px="10%">Não enviaremos Newsletters. Se quiser receber comunicados eventuais sobre oportunidades de pesquisa, negócios e atuação nas áreas de ÁGUA-OCEANO, inscreva-se aqui:</Typography>
            ...
            <Grid item md={6}>
                <Box my="25px">
                    ...
                    <TextField 
                        ...
                        variant="filled" 
                        id="nome" 
                        onChange={({ target }) => handleKeepContactInput(target.value, 'nome')} 
                    />
                </Box>
                <Box my="25px">
                    <Typography variant="body1" color={colors.blueLighter}>E-mail*</Typography>
                    <TextField
                        ...
                        variant="filled" 
                        id="email" 
                        onChange={({ target }) => handleKeepContactInput(target.value, 'email')} 
                    />
                </Box>
                <Box my="25px">
                    <Typography variant="body1" color={colors.blueLighter}>Linkedin</Typography>
                    <TextField 
                        ...
                        variant="filled" 
                        id="linkedin" 
                        onChange={({ target }) => handleKeepContactInput(target.value, 'linkedin')} 
                    />
                </Box>
            </Grid>
            <Grid item md={6}>
                <Box my="25px">
                    ...
                    <TextField 
                        ...
                        variant="filled" 
                        id="instagram" 
                        onChange={({ target }) => handleKeepContactInput(target.value, 'instagram')} 
                    />
                </Box>
                <Box my="25px">
                    <Typography variant="body1" color={colors.blueLighter}>Twitter</Typography>
                    <TextField
                        required 
                        fullWidth 
                        variant="filled" 
                        id="twitter" 
                        onChange={({ target }) => handleKeepContactInput(target.value, 'twitter')} 
                    />
                </Box>
            </Grid>
        </Grid>
