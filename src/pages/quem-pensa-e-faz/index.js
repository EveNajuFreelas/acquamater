...
export const QuemPensaFaz = () => {
	...
	return (
		<Box>
			...
			/>
			<BoxQuemPensaFaz position='relative'>
				<BackgroundImageQuemPensaFaz
					src='/acquamater/quem-pensa-faz/quem-pensa-faz-section-1.png'
					alt='BG'
				/>
				<TextOrganism
					variant='body1'
				...
				>
					...
					várias células, que são PESSOAS e ORGANIZAÇÕES com as quais
					trocamos ideias, idealizamos e realizamos projetos,
					potencializados por meio da cooperação e da diversidade
					cultural que caracteriza nossos parceiros, com os quais
					compartilhamos valores e objetivos.
				</TextOrganism>
			...
			<Wrapper style={{ marginBottom: '50px' }}>
				<Grid container spacing={3}>
					<Grid item xs={12} md={6}>
						<img
							src='/acquamater/patricia-furtado-2.png'
							alt='Patrícia'
							width='100%'
						/>
					</Grid>
					<Grid item xs={12} md={5}>
						...
						<Typography variant='body1'>
							...
							Inspiracional / Storyteller, Defensora do Oceano e
							das Águas, Facilitadora de Experiências de Reconexão
							com a Água e com o Oceano, Mergulhadora;
							<br />
							- "Profissional de ImPacto" da Rede Brasil do Pacto
							Global da ONU;
							<br />
							- Co-líder do Componente "Treinamento" do OLWA
							(Ocean Literacy With All), programa coordenado pela
							COI-UNESCO e endossado pela Década do Oceano da ONU;
							<br />
							- Coordenadora-Brasil da RELATO (Red de Educación
							Latino Americana para el Océano);
							<br />- Mentora e Conselheira de várias organizações
							internacionais voltada para jovens, como
							Waterlution, Sustainable Ocean Alliance, UNFCCC
							YOUNGO Ocean's Voice, entre outras
							<br /> <br />
							Patricia atua na interface
							Artes-Educação-Sustentabilidade há mais de 20 anos,
							tendo trabalhado em âmbito acadêmico, artístico,
							empresarial, governamental e do terceiro setor.
							Multipotencial e motivada por sua imensa paixão por
							rios e mares, funda a ACQUA MATER em 2017 e coloca a
							ÁGUA e o OCEANO ao centro de todas as suas
							atividades.
						</Typography>
						<Button
							onClick={() => navigate('/patricia-furtado')}
			...
			<Box position='relative'>
				<BackgroundImage
					src='/acquamater/advisory-board-bg.png'
					alt='BG'
				/>
			...
			<ParceirosContainer>
				...
				<Grid container spacing={2} marginBottom={2}>
					{Array.from(Array(10)).map(a => (
						<ParceiroImg
							src='/acquamater/white-placeholder.png'
							key={a}
						/>
					))}
				</Grid>
