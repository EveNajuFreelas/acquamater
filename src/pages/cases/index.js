		...
		<Box>
			...
			>
				<Typography variant='body2' color='white'>
					...
					o “Dialogo entre o ODS 6e o ODS 14" <br />a “Reconexao de
					Pessoas e Organizacdées com o Mundo ÁGUA-OCEANO”.
				</Typography>
			</Head>
			...
			<Box textAlign='center' mt='100px' mb='50px'>
				<Wrapper>
					...
					<Grid container spacing={2} mt='40px' minHeight='480px'>
						{BrasilCases.map(
							(
								{ image, project, client, where, when },
								index
							) => (
								<Grid
									item
