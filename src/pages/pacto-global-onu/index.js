...
export const PactoGlobalONU = () => (<Box>
    ...
    <Box my="100px" width="70%" mx="auto">
        <Grid container spacing={2} mb="50px">
            <Grid item md={6}>
                <img src="/acquamater/ods-wheel.png" alt="ODS wheel" width="80%" />
            </Grid>
            <Grid item md={6}>
        ...
        <Grid container spacing={2} my="50px">
            <Grid item md={6}>
                <img src="/acquamater/profissionais-impacto.png" alt="Selo Profissionais de imPacto" width="70%" />
            </Grid>
            <Grid item md={6}>
    ...
    <ObjetivosContainer>
        ...
        <Box mt="30px">
            <img width="700px" src="/acquamater/principais-ods.png" alt="ODSs"/>
        </Box>
    </ObjetivosContainer>
    <LinksContainer>
        ...
        <Box 
            ...
            width="700px"
        >
            <img src="/acquamater/un-global-compact-logo.png" alt="ODS6" width="100px" height="100px" />
            <img src="/acquamater/blue-keepers-logo.png" alt="ODS6" width="100px" height="100px" />
            <img src="/acquamater/pacto-global-rb-logo.png" alt="ODS6" width="150px" height="50px" />
            <img src="/acquamater/movimento-+-agua-logo.png" alt="ODS6" width="200px" height="100px" />
        </Box>
    </LinksContainer>
</Box>);