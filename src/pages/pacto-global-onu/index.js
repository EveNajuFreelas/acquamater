			...
			<Box my='100px' mx='auto'>
				<Grid container spacing={2} mb='50px'>
					...
					<Grid item md={6}>
						<Typography variant='body1' textAlign='end'>
							...
							difusão dos princípios do Pacto Global da ONU em
							2006, quando era Especialista em Responsabilidade
							Social da Ampla (atual Enel Energia), coordenando
							projetos socioculturais da empresa e redigindo seu
							Relatório de Sustentabilidade, já no modelo GRI
							(Global Reporting Initiative). Quando fundou a Acqua
							Mater,envolveu-se imediatamente com as ações do
							Pacto Global da ONU Brasil, principalmente as
							promovidas pela Plataforma Ação pela Água e Oceano,
							da qual é integrante desde 2019.
						</Typography>
					</Grid>
				</Grid>

				<Typography variant='body1'>
					Em 2021, A Acqua Mater tornou-se signatária do Global
					Compact e Patricia Furtado foi reconhecida como
				...
				<Grid container spacing={2} my='50px'>
					...
					<Grid item md={6}>
						<Typography variant='body1'>
							...
							do Pacto Global da ONU Brasil: tornou-se signatária
							do "Pacto pela Resiliência Hídrica" e do "Movimento
							+ Água", além de passar a integrar o Projeto "Blue
							Keepers", voltado à despoluição marinha. <br />{' '}
							<br /> Ainda em 2022, torna-se signatária dos
							"Princípios do Oceano Sustentável" (Sustainable
							Ocean Principles), iniciativa da "Coalizão pela
							Governança do Oceano" (Ocean Stewardship Coalition)
				...
				<Box my='50px'>
					<PersonQuoteCard
						...
						personImg='/acquamater/quem-pensa-faz/people/gabriela-otero.png'
						name='Gabriela Otero'
		...
		<ObjetivosContainer>
			<Wrapper style={{ alignItems: 'flex-start' }}>
				...
				<Box mt='30px'>
					<img
						width='700px'
						src='/acquamater/principais-ods.png'
						alt='ODSs'
					/>
				</Box>
			</Wrapper>
