	...
	return (
		<Box>
			...
			<Wrapper>
				<IntroContainer>
					...
					<Typography variant='body1'>
						...
						participação de nosso Advisory Board e de uma ampla rede
						de Parceiros.
					</Typography>
			...
			<QuoteSection
				text='ESSÊNCIA'
				textStyle='h3'
				background='/acquamater/como-atuamos-quote-bg.png'
			>
			...
			<SubfooterContainer>
				<Wrapper>
					<ColumnTextImage
						image={{
							isBg: false,
							img: '/acquamater/acquamater-logo.svg',
						}}
						title='Apresentação Institucional Acqua Mater'
						noPadding
						subfooter
						lowercase
					>
						{/* <Typography variant='h3'>
							Apresentação Institucional <br /> Acqua Mater
						</Typography> */}
